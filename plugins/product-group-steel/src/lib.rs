//! Iron & Steel product group plugin — EU ESPR carbon intensity and recycled content.
//!
...
//! direct-reduction ≤ 1.0. "steel" is the **product group**; the steel form
...
impl DppProductGroupPlugin for SteelPlugin {
