//! Electronics product group plugin — EU Reg. 2023/1670 + 2023/1669.
//!
//! Compliance rules:
...
//!
//! "electronics" is the **product group**; `productCategory` (one of the four
...
impl DppProductGroupPlugin for ElectronicsPlugin {
