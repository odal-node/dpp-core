...
| "May I change this struct — it's already stored somewhere?" | [architecture/PERSISTED-SHAPES.md](architecture/PERSISTED-SHAPES.md) — the one place pre-1.0 breaking changes are *not* free |
