...
- **Independence** — this crate must stand alone. Someone who vendors it from
  ...
  the pointer is the only part of such a sentence that does not survive
  vendoring. The issue tracker is not that surface: an issue may name and link
  a public sibling, provided it still carries its substance in this repo's own
  terms, so an outside contributor can act on it without opening anything else.
