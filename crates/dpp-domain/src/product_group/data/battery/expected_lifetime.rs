//! [`ExpectedLifetime`](crate::product_group::ExpectedLifetime) — the declared lifetime figures under Annex XIII.
...
///
/// **Not the same thing as [`BatteryData::expected_lifetime_cycles`](crate::product_group::BatteryData::expected_lifetime_cycles).** That
...
pub struct ExpectedLifetime {
    ...
    ///    item 1, is [`BatteryData::manufacturing_date`](crate::product_group::BatteryData::manufacturing_date).
