...
/// [`Instrument::id`](crate::instrument::Instrument::id).
///
...
/// [`Instrument::parent`](crate::instrument::Instrument::parent) rather than by
...
pub enum InstrumentKind {
    ...
    /// [`Instrument::parent`](crate::instrument::Instrument::parent).
    ///
