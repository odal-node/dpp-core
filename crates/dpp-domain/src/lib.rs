...
pub use domain::{
    ...
    sector::{
        ...
        ExpectedLifetime, FibreEntry, FurnitureData, HarmfulEvents, LifecycleStage,
        ...
        SystemBoundary, TextileData, ToyData, TyreData, UnsoldGoodsDestination, UnsoldGoodsReason,
