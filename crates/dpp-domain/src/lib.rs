...
pub use domain::{
    ...
    sector::{
        ...
        LifecycleStage, MaterialComposition, ProductionRoute, RepairCriterion, RepairabilityScore,
        Sector, SectorData, StateOfChargeReading, StateOfHealth, SteelData, SurfactantEntry,
