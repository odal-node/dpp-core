...
/// rule on [`SealCapabilities::can_produce`](crate::seal::SealCapabilities::can_produce) worth having.
///
...
impl SealConformanceLevel {
    /// Every level this build models. Same reasoning as [`SealFormat::ALL`](crate::seal::SealFormat::ALL).
