...
impl SealEnvelope {
    /// Every packaging this build models. Same reasoning as [`SealFormat::ALL`](crate::seal::SealFormat::ALL).
    ///
    /// The union across formats. To enumerate the packagings that are legal for
    /// one format, use [`SealFormat::envelopes`](crate::seal::SealFormat::envelopes).
