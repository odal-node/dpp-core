...
///
/// Findings are split into [`ComplianceResult::violations`](crate::compliance::ComplianceResult::violations) (binding — block
/// publish for an in-force product group) and [`ComplianceResult::warnings`](crate::compliance::ComplianceResult::warnings)
