//! `did:web` DID-to-URL resolution (W3C did:web method spec), shared by the
//! CLI's `--online` mode and the engine-side evidence exporter's
//! transfer-chain counterparty lookup. Pure string transform — no I/O here,
//! callers do their own HTTP fetch.
